...
\index{String@{String}!insert@{insert}}
\index{insert@{insert}!String@{String}}
...
\index{String@{String}!toArray@{toArray}}
\index{toArray@{toArray}!String@{String}}
\subsubsection[{toArray}]{\setlength{\rightskip}{0pt plus 5cm}String::toArray (\$ {\em offset} = {\ttfamily 0}, \/  \$ {\em len} = {\ttfamily null})}}
...
\index{String@{String}!toString@{toString}}
\index{toString@{toString}!String@{String}}
